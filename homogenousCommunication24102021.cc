...
NS_LOG_COMPONENT_DEFINE ("Homogeneous");
...
void experiment(int &numberOfUEs, const std::string phyMode1, const std::string phyMode2, bool verbose, double duration, Ptr<WifiPhyStats> m_wifiPhyStats, int m_mobility, double m_txp, uint32_t m_protocol)
{
...
//     DsrMainHelper dsrMain;
  ...
  //   internet.Install(ueNode);
    ...
    // WIFI_PHY_STANDARD_80211n_2_4GHZ execution
...
//
   ...
   //  Time JittersumWifi;
    ...
    flowMonitor->SerializeToXmlFile("homogeneous.xml", true, true);
...
int main (int argc, char *argv[])
{
  ...
  //  std::cout << "F1 Tx Packets;F1 Rx Packets;F1 Tx Bytes;F1 Rx Bytes;F2 Tx Packets;F2 Rx Packets;F2 Tx Bytes;F2 Rx Bytes;Collisions\n";
    ...
    {
        experiment(numberOfUEs, phyMode1, phyMode2, verbose, duration, m_wifiPhyStats, m_mobility, m_txp, m_protocol);
