...
//InterMan
void InterfaceManager(NodeContainer ueNode, UdpClientHelper dlClient, UdpClientHelper wdlClient){
    //sleep (5);
    int sumPointsIntA=0, sumPointsIntB=0;// c=0; // A=Wifi 2.4GHz B = Wave 5.9GHz C=802.11ac D=802.11ax 2.4GHz E=802.11ax 5GHz
    int change;
...
if (numberofexecution > 3) {
    ...
    Simulator::Schedule (Seconds (1), &InterfaceManager, ueNode, dlClient, wdlClient);
  }
...
//
   ...
   std::cout << "Wifi_2.4--Wave5. Intefaces Installed!. Done!" << std::endl;
    ...
    //           }
        ...
        //InterMan
         InterfaceManager (ueNode, dlClient, wdlClient);
