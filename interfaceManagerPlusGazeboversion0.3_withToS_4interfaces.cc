...
//  uint8_t tid = QosUtilsGetTidForPacket (packet);
  ...
  // uint16_t portNumber = sink.GetPort();
  ...
  //
          ...
          std::cout <<  "Now:" << Simulator::Now ().GetSeconds () << ", Received packet with Tos from "<<iph.GetSource()<<" to "<<iph.GetDestination()<<std::endl;
  }
...
//InterMan
void InterfaceManager(NodeContainer ueNode, UdpClientHelper dlClient, UdpClientHelper wdlClient, UdpClientHelper acClient, UdpClientHelper ax2_4Client){
    //sleep (5);
    int sumPointsIntA=0, sumPointsIntB=0, sumPointsIntC=0, sumPointsIntD=0;// c=0; // A=Wifi 2.4GHz B = Wave 5.9GHz C=802.11ac D=802.11ax 2.4GHz E=802.11ax 5GHz
    int change;
...
if (numberofexecution > 3) {
                ...
                //if (Simulator::Now ().GetSeconds () > 5000000000) {
                      ...
                      if (AvgVetBytesReceivedWave > AvgVetBytesReceivedWifi && AvgVetBytesReceivedWave > AvgVetBytesReceivedAc && AvgVetBytesReceivedWave > AvgVetBytesReceivedAx_2_4){
                                sumPointsIntB = sumPointsIntB + 1;
                                std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                              } else if (AvgVetBytesReceivedWifi > AvgVetBytesReceivedWave && AvgVetBytesReceivedWifi > AvgVetBytesReceivedAc && AvgVetBytesReceivedWifi > AvgVetBytesReceivedAx_2_4) {
                                        sumPointsIntA = sumPointsIntA + 1;
                                        std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                      } else if (AvgVetBytesReceivedAc > AvgVetBytesReceivedWifi && AvgVetBytesReceivedAc > AvgVetBytesReceivedWave && AvgVetBytesReceivedAc > AvgVetBytesReceivedAx_2_4) {
                                                  sumPointsIntC = sumPointsIntC + 1;
                                                  std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                                } else if (AvgVetBytesReceivedAx_2_4 > AvgVetBytesReceivedWifi && AvgVetBytesReceivedAx_2_4 > AvgVetBytesReceivedWave && AvgVetBytesReceivedAx_2_4 > AvgVetBytesReceivedAc) {
                                                              sumPointsIntD = sumPointsIntD + 1;
                                                              std::cout << "sumPointsIntD: " << sumPointsIntD << std::endl;
                                                            }// else if (AvgVetBytesReceivedAx5 > AvgVetBytesReceivedWifi && AvgVetBytesReceivedAx5 > AvgVetBytesReceivedWave && AvgVetBytesReceivedAx5 > AvgVetBytesReceivedAc) {
                      ...
                      if (AvgVetBytesDropWave > AvgVetBytesDropWifi && AvgVetBytesDropWave > AvgVetBytesDropAc && AvgVetBytesDropWave > AvgVetBytesDropAx_2_4){
                                sumPointsIntB = sumPointsIntB + 1;
                                std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                              } else if (AvgVetBytesDropWifi > AvgVetBytesDropWave && AvgVetBytesDropWifi > AvgVetBytesDropAc && AvgVetBytesDropWifi > AvgVetBytesDropAx_2_4) {
                                        sumPointsIntA = sumPointsIntA + 1;
                                        std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                      } else if (AvgVetBytesDropAc > AvgVetBytesDropWifi && AvgVetBytesDropAc > AvgVetBytesDropWave && AvgVetBytesDropAc > AvgVetBytesDropAx_2_4) {
                                                  sumPointsIntC = sumPointsIntC + 1;
                                                  std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                        } else if (AvgVetBytesDropAx_2_4 > AvgVetBytesDropWifi && AvgVetBytesDropAx_2_4 > AvgVetBytesDropWave && AvgVetBytesDropAx_2_4 > AvgVetBytesDropAc) {
                                                      sumPointsIntD = sumPointsIntD + 1;
                                                      std::cout << "sumPointsIntD: " << sumPointsIntD << std::endl;
                      ...
                      // bytes throughput --- c3
                      if (AvgthroughputWave > AvgthroughputWifi && AvgthroughputWave > AvgthroughputAc && AvgthroughputWave > AvgthroughputAx_2_4){
                                sumPointsIntB = sumPointsIntB + 1;
                                std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                              } else if (AvgthroughputWifi > AvgthroughputWave && AvgthroughputWifi > AvgthroughputAc && AvgthroughputWifi > AvgthroughputAx_2_4) {
                                        sumPointsIntA = sumPointsIntA + 1;
                                        std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                      } else if (AvgthroughputAc > AvgthroughputWifi && AvgthroughputAc > AvgthroughputWave && AvgthroughputAc > AvgthroughputAx_2_4) {
                                                  sumPointsIntC = sumPointsIntC + 1;
                                                  std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                        } else if (AvgVetBytesDropAx_2_4 > AvgVetBytesDropWifi && AvgVetBytesDropAx_2_4 > AvgVetBytesDropWave && AvgVetBytesDropAx_2_4 > AvgVetBytesDropAc) {
                                                      sumPointsIntD = sumPointsIntD + 1;
                        ...
                        if (AvgTotalBytesReceivedSumWave > AvgtotalBytesReceivedSumWifi && AvgTotalBytesReceivedSumWave > AvgtotalBytesReceivedSumAc && AvgTotalBytesReceivedSumWave > AvgtotalBytesReceivedSumAx_2_4){
                                  sumPointsIntB = sumPointsIntB + 1;
                                  std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                                } else if (AvgtotalBytesReceivedSumWifi > AvgTotalBytesReceivedSumWave && AvgtotalBytesReceivedSumWifi > AvgtotalBytesReceivedSumAc && AvgtotalBytesReceivedSumWifi > AvgtotalBytesReceivedSumAx_2_4) {
                                          sumPointsIntA = sumPointsIntA + 1;
                                          std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                        } else if (AvgtotalBytesReceivedSumAc > AvgtotalBytesReceivedSumWifi && AvgtotalBytesReceivedSumAc > AvgTotalBytesReceivedSumWave && AvgtotalBytesReceivedSumAc > AvgtotalBytesReceivedSumAx_2_4) {
                                                    sumPointsIntC = sumPointsIntC + 1;
                                                    std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                          } else if (AvgtotalBytesReceivedSumAx_2_4 > AvgtotalBytesReceivedSumWifi && AvgtotalBytesReceivedSumAx_2_4 > AvgTotalBytesReceivedSumWave && AvgtotalBytesReceivedSumAx_2_4 > AvgtotalBytesReceivedSumAc) {
                                                        sumPointsIntD = sumPointsIntD + 1;
                                                        std::cout << "sumPointsIntD: " << sumPointsIntD << std::endl;
                      ...
                      if (AvgVet_g_signalDbmAvgWave > AvgVet_g_signalDbmAvgWifi && AvgVet_g_signalDbmAvgWave > AvgVet_g_signalDbmAvgAc && AvgVet_g_signalDbmAvgWave > AvgVet_g_signalDbmAvgAx_2_4){
                                sumPointsIntB = sumPointsIntB + 1;
                                std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                              } else if (AvgVet_g_signalDbmAvgWifi > AvgVet_g_signalDbmAvgWave && AvgVet_g_signalDbmAvgWifi > AvgVet_g_signalDbmAvgAc && AvgVet_g_signalDbmAvgWifi > AvgVet_g_signalDbmAvgAx_2_4) {
                                        sumPointsIntA = sumPointsIntA + 1;
                                        std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                      } else if (AvgVet_g_signalDbmAvgAc > AvgVet_g_signalDbmAvgWifi && AvgVet_g_signalDbmAvgAc > AvgVet_g_signalDbmAvgWave && AvgVet_g_signalDbmAvgAc > AvgVet_g_signalDbmAvgAx_2_4) {
                                                  sumPointsIntC = sumPointsIntC + 1;
                                                  std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                        } else if (AvgVet_g_signalDbmAvgAx_2_4 > AvgVet_g_signalDbmAvgWifi && AvgVet_g_signalDbmAvgAx_2_4 > AvgVet_g_signalDbmAvgWave && AvgVet_g_signalDbmAvgAx_2_4 > AvgVet_g_signalDbmAvgAc) {
                                                      sumPointsIntD = sumPointsIntD + 1;
                                                      std::cout << "sumPointsIntD: " << sumPointsIntD << std::endl;
                      ...
                      //noise Dbm Avg --- c6
                      if (AvgVet_g_noiseDbmAvgWave > AvgVet_g_noiseDbmAvgWifi && AvgVet_g_noiseDbmAvgWave > AvgVet_g_noiseDbmAvgAc && AvgVet_g_noiseDbmAvgWave > AvgVet_g_noiseDbmAvgAx_2_4){
                                sumPointsIntB = sumPointsIntB + 1;
                                std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                              } else if (AvgVet_g_noiseDbmAvgWifi > AvgVet_g_noiseDbmAvgWave && AvgVet_g_noiseDbmAvgWifi > AvgVet_g_noiseDbmAvgAc && AvgVet_g_noiseDbmAvgWifi > AvgVet_g_noiseDbmAvgAx_2_4) {
                                        sumPointsIntA = sumPointsIntA + 1;
                                        std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                      } else if (AvgVet_g_noiseDbmAvgAc > AvgVet_g_noiseDbmAvgWifi && AvgVet_g_noiseDbmAvgAc > AvgVet_g_noiseDbmAvgWave && AvgVet_g_noiseDbmAvgAc > AvgVet_g_noiseDbmAvgAx_2_4){
                                                  sumPointsIntC = sumPointsIntC + 1;
                                                  std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                        } else if (AvgVet_g_noiseDbmAvgAx_2_4 > AvgVet_g_noiseDbmAvgWifi && AvgVet_g_noiseDbmAvgAx_2_4 > AvgVet_g_noiseDbmAvgWave && AvgVet_g_noiseDbmAvgAx_2_4 > AvgVet_g_noiseDbmAvgAc) {
                                                      sumPointsIntD = sumPointsIntD + 1;
                                                      std::cout << "sumPointsIntD: " << sumPointsIntD << std::endl;
                                                  }  // } else if (AvgVet_g_noiseDbmAvgAx5 > AvgVet_g_noiseDbmAvgWifi && AvgVet_g_noiseDbmAvgAx5 > AvgVet_g_noiseDbmAvgWave && AvgVet_g_noiseDbmAvgAx5 > AvgVet_g_noiseDbmAvgAc) {
                                                    //               sumPointsIntE = sumPointsIntE + 1;
                                                    //               std::cout << "sumPointsIntE: " << sumPointsIntE << std::endl;
                                                    //               }
                      ...
                      if (AvgVet_g_SNRWave > AvgVet_g_SNRWifi && AvgVet_g_SNRWave > AvgVet_g_SNRAc && AvgVet_g_SNRWave > AvgVet_g_SNRAx_2_4){
                                sumPointsIntB = sumPointsIntB + 1;
                                std::cout << "sumPointsIntB: " << sumPointsIntB << std::endl;
                              } else if (AvgVet_g_SNRWifi > AvgVet_g_SNRWave && AvgVet_g_SNRWifi > AvgVet_g_SNRAc && AvgVet_g_SNRWifi > AvgVet_g_SNRAx_2_4) {
                                        sumPointsIntA = sumPointsIntA + 1;
                                        std::cout << "sumPointsIntA: " << sumPointsIntA << std::endl;
                                      } else if (AvgVet_g_SNRAc > AvgVet_g_SNRWifi && AvgVet_g_SNRAc > AvgVet_g_SNRWave && AvgVet_g_SNRAc > AvgVet_g_SNRAx_2_4){
                                                  sumPointsIntC = sumPointsIntC + 1;
                                                  std::cout << "sumPointsIntC: " << sumPointsIntC << std::endl;
                                        } else if (AvgVet_g_SNRAx_2_4 > AvgVet_g_SNRWifi && AvgVet_g_SNRAx_2_4 > AvgVet_g_SNRWave && AvgVet_g_SNRAx_2_4 > AvgVet_g_SNRAc) {
                                                      sumPointsIntD = sumPointsIntD + 1;
                                                      std::cout << "sumPointsIntD: " << sumPointsIntD << std::endl;
                                                  }  // } else if (AvgVet_g_SNRAx5 > AvgVet_g_SNRWifi && AvgVet_g_SNRAx5 > AvgVet_g_SNRWave && AvgVet_g_SNRAx5 > AvgVet_g_SNRAc) {
                                                    //               sumPointsIntE = sumPointsIntE + 1;
                                                    //               std::cout << "sumPointsIntE: " << sumPointsIntE << std::endl;
                                                    //               }
                  ...
                  //    std::cout << "Number of Points Interface E, " << sumPointsIntE << std::endl;
                      ...
                      if (sumPointsIntB > sumPointsIntA && sumPointsIntB > sumPointsIntC && sumPointsIntB > sumPointsIntD){
                            ...
                            //      TearDownLink (ueNode.Get(1), ueNode.Get(j),5,5);
                              ...
                              } else if (sumPointsIntA > sumPointsIntB && sumPointsIntA > sumPointsIntC && sumPointsIntA > sumPointsIntD){
                                ...
                                //            TearDownLink (ueNode.Get(1), ueNode.Get(j),5,5);
                                            ...
                                            TearUpLink (ueNode.Get(1), ueNode.Get(j),1,1,j);
                                     ...
                                     } else if (sumPointsIntC > sumPointsIntB && sumPointsIntC > sumPointsIntA && sumPointsIntC > sumPointsIntD) {
                                               ...
                                               for (uint32_t j=0; j < ueNode.GetN();j++){
                                                      ...
                                                      } else if (sumPointsIntD > sumPointsIntB && sumPointsIntD > sumPointsIntA && sumPointsIntD > sumPointsIntC) {
    ...
    Simulator::Schedule (Seconds (1), &InterfaceManager, ueNode, dlClient, wdlClient, acClient, ax2_4Client);
  }
...
//          // Only set the channel width and guard interval for HT and VHT modes
   ...
   std::cout << "Wifi_2.4--Wave5--Ac5--Ax2.4 Intefaces Installed!. Done!" << std::endl;
...
//                            snprintf (novoId_sd_d, 20, "send:%d-%s-node:%d", run_ev, id_sdD, i_4);
              ...
              //       char id_5[5] = "rd_e";
              //       char id_sdE[5] = "sd_e";
              //       char novoId_5[10], novoId_sd_e[10];
              //
              //
              //
              //       for (uint32_t u = 0; u < ueNode.GetN (); ++u)
              ...
              //
              //         snprintf (novoId_sd_e, 10, "%d_%s%d", seq_5, id_sdE, i_5);
              //
              //         EvalvidServerHelper server (port);
              //         server.SetAttribute ("SenderTraceFilename", StringValue("st_highway_cif.st"));
              //         server.SetAttribute ("SenderDumpFilename", StringValue(novoId_sd_e));
              //         server.SetAttribute ("PacketPayload",UintegerValue(pktSize));
              //
              //
              //         ApplicationContainer apps = server.Install (ueNode.Get(u));
              //         apps.Start (Seconds (duration/2+0.1));
              //         apps.Stop (Seconds (duration+1.0));
              //
              ...
              //         apps = client.Install (ueNode.Get (u));
              //
              //         std::cout << "Now:" << Simulator::Now ().GetSeconds () << ",Sending video streamming, [" << seq_5 << "], from "<< ueNode.Get(u) << "---port--- " << port << ",Tos=" << "AC_VI" << ",Addr=" << address5 << ";" << std::endl;
              //
              //
              //         apps.Start (Seconds (duration/2+0.5));
              //         apps.Stop (Seconds (duration+1.0));
    ...
    //           }
        ...
        //InterMan
         ...
         InterfaceManager (ueNode, dlClient, wdlClient, acClient, ax2_4Client);
        ...
        Config::ConnectWithoutContext ("/NodeList/*/DeviceList/*/Phy/MonitorSnifferRx", MakeCallback (&MonitorSniffRx));
         ...
         Config::Connect ("/NodeList/*/$ns3::Node/ApplicationList/*/$ns3::PacketSocketServer/Rx", MakeCallback (&PrintReceivedPacket));
