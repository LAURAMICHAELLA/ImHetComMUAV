...
//change9
void experiment(int &numberOfUEs, const std::string phyMode1, bool verbose, Ptr<WifiPhyStats> m_wifiPhyStats, int m_mobility, uint32_t m_protocol, double duration)
{
...
//
   ...
   //  Time JittersumWifi;
    ...
    flowMonitor->SerializeToXmlFile("homogeneo.xml", true, true);
...
int main (int argc, char *argv[])
{
  ...
  //conection Gazebo
    ...
    int numberOfUEs=5; //Default number of UEs attached to each eNodeB
    bool verbose=false;
...
//    cmd.AddValue ("txp", "Transmit power (dB), e.g. txp=7.5", m_txp);
    ...
    LogComponentEnable ("EvalvidServer", LOG_LEVEL_INFO);
        ...
        {
            experiment(numberOfUEs, phyMode1, verbose,m_wifiPhyStats, m_mobility, m_protocol, duration);
